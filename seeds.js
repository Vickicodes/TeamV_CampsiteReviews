...
const data = [
	{
		...
		image:
			'https://images.squarespace-cdn.com/content/v1/54a92ea2e4b0d6033e4bbdbb/1420378787409-XH40TDJ6M5HRNZ3BAHN3/ke17ZwdGBToddI8pDm48kDHPSfPanjkWqhH6pl6g5ph7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0mwONMR1ELp49Lyc52iWr5dNb1QJw9casjKdtTg1_-y4jz4ptJBmI9gQmbjSQnNGng/IMG_0878.JPG',
	...
	},
	{
		...
		image:
			'https://www.camping-meursault.com/uploads/sites/14/2018/04/camping_grappe_d_or_mersault_emplacements_vignes.jpg',
	...
	},
	{
		...
		price: 20.0,
		description:
			"We are set in 4 acres of glorious Pembrokeshire countryside, it is a small, peaceful, family run campsite, with beautiful panoramic views over St Brides Bay to St David's and the Preseli Hills with glorious sunsets.",
		author: {
			id: '588c2e092403d111454fff76',
			username: 'Jack'
		}
...
function seedDB() {
	Campsite.countDocuments({}, function(err, count) {
		...
		data.forEach(function(seed) {
			...
			Campsite.create(newCampsite, function(err) {
				if (err) {
					console.log(err);
				} else {
